...
const ExpCovidTracker = ({
  ...
  return (
    <div className="f-content f-home">
      <iframe
        src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=1t9sSeZyLFykxPpd3ep3-DioIHiEBpF5v2scdMSk7xN8&font=Default&lang=en&initial_zoom=2&height=750"
        width="100%"
        height="750"
...
export default connect(mapStateToProps, null)(ExpCovidTracker);
