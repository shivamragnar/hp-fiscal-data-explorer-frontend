...
const financialYears = [{label: "2015-16", disabled: true}, {label: "2016-17", disabled: true}, {label: "2017-18", disabled: false}, {label: "2018-19", disabled: false}, {label: "2019-20", disabled: false}, {label: "2020-21", disabled: false}, ]
    ...
    <Radio.Group defaultValue={"2020-21"} buttonStyle="solid" className={props.className} onChange={props.onChange}>
      {
        financialYears.map((year, i) => {
          if(i===0 || i===1 || i===5){
            return (
              <Tooltip title={i === 0 || i===1 ? TooltipText[0] : TooltipText[1] } >
