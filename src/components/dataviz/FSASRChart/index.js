    ...
    return (
      ...
      />
        ...
        <VictoryGroup
          ...
          style={{ data: { width: this.props.barWidth, transform: "translateX(12px)" } }}
        >
        <VictoryStack >
          <VictoryBar key={0} style={{ data: { fill:  "#fff", opacity: "0" } }} data={data} x="month" y="sanction"/>
          <VictoryBar key={1} style={{ data: { fill:  "#000" } }} data={data} x="month" y="mark"/>
        </VictoryStack>
        <VictoryStack >
          <VictoryBar key={0} style={{ data: { fill:  "#fff", opacity: "0" } }} data={data} x="month" y="sanction"/>
          <VictoryBar key={1} style={{ data: { fill:  "#000" } }} data={data} x="month" y="mark"/>
          <VictoryBar key={2} style={{ data: { fill:  "#FF6100" } }} data={data} x="month" y="addition"/>
        </VictoryStack>
        <VictoryStack >
          <VictoryBar key={0} style={{ data: { fill:  "#fff", opacity: "0" } }} data={data} x="month" y="revision"/>
          <VictoryBar key={1} style={{ data: { fill:  "#000" } }} data={data} x="month" y="mark"/>
          <VictoryBar key={1} style={{ data: { fill:  "#0077FF" } }} data={data}  x="month" y="saving"/>
        </VictoryStack>
        <VictoryStack >
          <VictoryBar key={0} style={{ data: { fill:  "#fff", opacity: "0"} }} data={data} x="month" y="revision"/>
          <VictoryBar key={1} style={{ data: { fill:  "#000" } }} data={data} x="month" y="mark"/>
